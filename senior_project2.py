...
df_aapl_close = web.DataReader('THYAO.IS', data_source='yahoo', start='2019-11-01', end='2022-06-08')
...
#take data 
df = web.DataReader('THYAO.IS', data_source='yahoo', start='2019-11-01', end='2022-06-08')
...
#train the model
history = model.fit(x_train, y_train, batch_size=64, validation_split=0.1, epochs=1) #BIM batch_size=16
model.save('aaa.h5')
