...
#take data 
df = web.DataReader('KRDMD.IS', data_source='yahoo', start='2019-11-01', end='2022-04-20')
...
#train the model
history = model.fit(x_train, y_train, batch_size=16, validation_split=0.1, epochs=100)
model.save('kardemir.h5')
